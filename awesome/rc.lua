...
local cw = calendar_widget({theme = 'nord', placement = 'top_right'})
...
globalkeys = gears.table.join(
    awful.key({ modkey,           }, "v",      hotkeys_popup.show_help,
...
local tab_binds = {'a', 's', 'd', 'u', 'i', 'o', ',', '.', '/'}

for i = 1, 9 do
    globalkeys = gears.table.join(globalkeys,
        -- View tag only.
        awful.key({ modkey }, tab_binds[i],
                  function ()
        ...
        -- Toggle tag display.
        awful.key({ modkey, "Control" }, tab_binds[i],
                  function ()
                      local screen = awful.screen.focused()
                      local tag = screen.tags[i]
                      if tag then
        ...
        -- Move client to tag.
        awful.key({ modkey, "Shift" }, tab_binds[i],
                  function ()
                      if client.focus then
